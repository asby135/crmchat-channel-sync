...
export const ru: Locale = {
  // ── start.ts ──────────────────────────────────────────────────────
  welcome:
    "Привет! 👋\n\nОтправь мне API-ключ CRMChat, чтобы начать.\n\nНайти его можно в *Настройки > API-ключи* в @crmchat_crm_bot.",
  ...
  invalidApiKey: "❌ Неверный API-ключ.\n\nПроверь в *Настройки > API-ключи* в @crmchat_crm_bot.",
  ...
  settingsNoConfigurableProps:
    "Кастомные поля не найдены.\n\nСначала создай поле типа single-select или text в @crmchat_crm_bot > *Кастомные поля*.",
  ...
  settingsMappingSaved: (propName: string, joinLabel: string, leaveLabel: string) =>
    `✅ Настройки сохранены!\n\n${propName}:\n  Вступление → ${joinLabel}\n  Выход → ${leaveLabel}\n\n💡 Настрой автоматические рассылки в @crmchat_crm_bot > *Рассылки > Лиды из CRM*.`,
